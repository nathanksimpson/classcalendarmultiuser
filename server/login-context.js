 ...
 * Affects session cookie lifetime and idle auto sign-out for that session only.
 */
const LOGIN_CONTEXT_PERSONAL = 'personal';
const LOGIN_CONTEXT_SHARED = 'shared';

const SHARED_SESSION_MAX_DAYS = 1;
const SHARED_IDLE_LOGOUT_MINUTES = 15;
const SHARED_IDLE_WARNING_MINUTES = 2;

function sanitizeLoginContext(value) {
...
function resolveLoginProfile(loginContext, adminSettings) {
...
function sessionPolicyFromRow(row, adminSettings) {
