...
const translations = {
    en: {
        ...
        teamLockTakenFlash: 'You took over editing from {name}.',
        ...
        teamLockTakeFailed: 'Could not take over editing. Try again.',
