...
(function (global) {
    const ADMIN_STRINGS = {
        en: {
            ...
            viewAs: 'View as',
            viewAsTitle: 'Open the calendar app in a new tab as this user',
            confirmViewAs: 'Open a new tab and view the site as {name}? Changes will not be saved.',
        ...
        ko: {
            ...
            viewAs: '다른 사용자로 보기',
            viewAsTitle: '새 탭에서 이 사용자로 캘린더 앱 열기',
            confirmViewAs: '새 탭에서 {name}(으)로 사이트를 보시겠습니까? 변경 사항은 저장되지 않습니다.',
