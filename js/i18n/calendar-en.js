(function (global) {
    ...
    global.CCPCalendarI18n.en = {
        ...
        eventNotifyEnabled: 'Remind me in the notifications bell',
        eventNotifyLeadDays: 'Days before to start alerting',
        eventNotifyLeadDays0: 'On the day only',
        eventNotifyHint: 'Alerts appear in the header bell before and on the event date.',
        eventAlertToday: '"{name}" is today ({date})',
        eventAlertUpcoming: '"{name}" in {days} days ({date})',
        eventAlertGo: 'View event',
