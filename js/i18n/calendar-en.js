(function (global) {
    ...
    global.CCPCalendarI18n.en = {
        ...
        classroomEssayClassSummaryFilterHint: 'Choose which assignments to include in print and copy.',
        ...
        classroomEssayRescanConfirm: 'Re-scan all your classes? Non-essay lessons will be unmarked and stray essay records for those lessons will be removed. Essay lessons are detected from the Essay checkbox or “essay” / “에세이” in the lesson text.',
        ...
        rosterTmsSyncCredsMissing:
            'TMS login is not configured. Add TMS_USERNAME and TMS_PASSWORD to your local .env file, then restart npm start.',
        rosterTmsSyncLoginFailed: 'Could not sign in to TMS. Check TMS_USERNAME / TMS_PASSWORD in .env.',
        ...
        rosterTmsSyncPreviewLine:
            '+{added} new · {matched} matched · {flagged} off roster · clear {cleared}',
