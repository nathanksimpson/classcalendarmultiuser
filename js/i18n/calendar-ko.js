(function (global) {
    ...
    global.CCPCalendarI18n.ko = {
        ...
        classroomEssayStatusSummary: '제출: {submitted} · 완료: {complete} · 재제출: {resubmit} · 미제출: {notSubmitted}',
        ...
        eventTypeOther: '기타',
        eventTypeHolidayHint: '해당 날짜(또는 기간)에 적용 대상 수업이 취소됩니다. 저장 후 강의 계획표 탭에서 캘린더에서 새로고침을 실행하세요.',
        eventTypeEvalPeriodHint: '기간 내 각 날짜에 적용 대상 수업이 취소됩니다. 저장 후 강의 계획표 탭에서 캘린더에서 새로고침을 실행하세요.',
