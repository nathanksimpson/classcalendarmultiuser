(function (global) {
    ...
    global.CCPCalendarI18n.ko = {
        ...
        eventNotifyEnabled: '알림 벨에 표시',
        eventNotifyLeadDays: '며칠 전부터 알림',
        eventNotifyLeadDays0: '당일만',
        eventNotifyHint: '이벤트 날짜 전·당일에 상단 벨 알림으로 표시됩니다.',
        eventAlertToday: '"{name}" 오늘 ({date})',
        eventAlertUpcoming: '"{name}" {days}일 후 ({date})',
        eventAlertGo: '이벤트 보기',
