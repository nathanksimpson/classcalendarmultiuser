(function (global) {
    ...
    global.CCPCalendarI18n.ko = {
        ...
        classroomEssayClassSummaryFilterHint: '인쇄·복사에 포함할 과제를 선택하세요.',
        ...
        classroomEssayRescanConfirm: '내 수업을 모두 다시 검색할까요? 에세이가 아닌 수업은 해제되고 해당 수업의 에세이 기록이 삭제됩니다. 에세이 수업은 체크박스 또는 수업 글에 “essay”/“에세이”가 있으면 찾습니다.',
        ...
        rosterTmsSyncCredsMissing:
            'TMS 로그인이 설정되지 않았습니다. 로컬 .env에 TMS_USERNAME과 TMS_PASSWORD를 넣고 npm start를 다시 실행하세요.',
        rosterTmsSyncLoginFailed: 'TMS 로그인에 실패했습니다. .env의 TMS_USERNAME / TMS_PASSWORD를 확인하세요.',
        ...
        rosterTmsSyncPreviewLine:
            '+{added} 신규 · {matched} 일치 · {flagged} 명단외 · 해제 {cleared}',
